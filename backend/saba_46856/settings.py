"""
Django settings for saba_46856 project.
...
WSGI_APPLICATION = 'saba_46856.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "saba_46856 API",
    "DESCRIPTION": "API documentation for saba_46856 App",
    "VERSION": "v1",
}
